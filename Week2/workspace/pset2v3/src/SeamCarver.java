...
public class SeamCarver {
    ...
    public Picture picture() {
        return new Picture(this.inputPicture);
    ...
    public double energy(int x, int y) {
        ...
        if ((x < 0 || x >= this.width()) || (y < 0 || y >= this.height())) {
            throw new java.lang.IllegalArgumentException("Invalid range for x or y to energy function");
        }
    ...
    public void removeVerticalSeam(int[] seam) {
        ...
        // call illegal argument if any seam argument is illegal
        if (!this.checkSeam(seam, h)) {
            throw new java.lang.IllegalArgumentException();
        }
       ...
       /* // Use copy constructor to create new image
        Picture copyPic = new Picture(this.inputPicture);
    ...
    private boolean checkSeam(int[] seam, int h) {
